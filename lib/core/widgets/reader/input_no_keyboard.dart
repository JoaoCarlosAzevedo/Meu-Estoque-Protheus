...
class InputWithKeyboardControlv2 extends EditableText {
  ...
  final InputWithKeyboardControlv2FocusNode focusNode;
  ...
  EditableTextState createState() {
    return InputWithKeyboardControlv2State(
        startShowKeyboard,
        focusNode,
        width,
        buttonColorEnabled,
...
class InputWithKeyboardControlv2State extends EditableTextState {
  ...
  InputWithKeyboardControlv2State(
      this.showKeyboard,
      this.focusNode,
      this.width,
...
class InputWithKeyboardControlv2FocusNode extends FocusNode {
  @override
